/* ==========================================================================
   1. SETTIMANA MINIMA (CORREZIONE AUTOMATICA)
   ========================================================================== */

function setupMinimumWeek() {
...
/* ==========================================================================
   3. GESTIONE INVIO E JSON (STORAGE)
   ========================================================================== */
...
function setupFormSubmission() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        // 1. Estrazione dei dati comuni a tutte le prenotazioni
        ...
        selectedWorkshops.forEach(checkbox => {
            ...
            // Controllo duplicati per ogni singola prenotazione
        ...
        if (addedCount > 0) {
            ...
            if (duplicateCount > 0) {
                alert(`Operazione completata: ${addedCount} nuove prenotazioni salvate. ${duplicateCount} risultavano già presenti.`);
            } else {
                alert("Tutte le tue prenotazioni sono state registrate con successo!");
            }
        } else if (duplicateCount > 0) {
            alert("Tutte le prenotazioni selezionate risultano già presenti nel sistema.");
        }
    });
}
